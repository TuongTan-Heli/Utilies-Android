...
export const update = async (TaskId: string, Name: string, Description: string, Type: string, Deadline: Date, Done: Date, EnableNoti: boolean, Priority: number, NotiOnDeadline: number, Price: number, CurrencyId: string) => {    
